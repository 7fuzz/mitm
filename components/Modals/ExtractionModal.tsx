...
export function ExtractionModal({ isOpen, onClose, onSave, initialRules, availableVariables }: ExtractionModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-100 flex items-center justify-center bg-backdrop backdrop-blur-sm px-4">
      <div className="bg-zinc-950 border border-zinc-800 rounded-lg shadow-2xl shadow-app-shadow w-full max-w-lg flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200">
